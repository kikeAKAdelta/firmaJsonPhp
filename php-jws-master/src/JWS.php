...
require_once "./php-jws-master/src/Algorithm/AlgorithmInterface.php";
require_once "./php-jws-master/src/Algorithm/HMACAlgorithm.php";
require_once "./php-jws-master/src/Algorithm/RSA_SSA_PKCSv15.php";

require_once "./php-jws-master/src/Exception/InvalidSignatureException.php";
require_once "./php-jws-master/src/Exception/MalformedSignatureException.php";
require_once "./php-jws-master/src/Exception/UnexpectedAlgorithmException.php";
require_once "./php-jws-master/src/Exception/UnspecifiedAlgorithmException.php";
require_once "./php-jws-master/src/Exception/UnsupportedAlgorithmException.php";

require_once "./php-jws-master/src/Util/Base64Url.php";
require_once "./php-jws-master/src/Util/Json.php";
